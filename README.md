...
1.  **Create a Gatsby site.**
    ...
    Use the Gatsby CLI to create a new site, specifying the GitHub repository link.

    ```shell
    gatsby new el-site https://github.com/elevatelearning/el-site
    ```
...
3.  **Open the source code and start editing!**
    ...
    Open the `el-site` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
